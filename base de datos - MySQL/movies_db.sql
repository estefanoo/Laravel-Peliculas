...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2020 a las 08:15:13
...
CREATE TABLE `actors` (
  ...
  `imagen_profile` varchar(255) COLLATE utf8_unicode_ci NOT NULL
...
INSERT INTO `actors` (`id`, `created_at`, `updated_at`, `first_name`, `last_name`, `rating`, `favorite_movie_id`, `imagen_profile`) VALUES
...
(50, '2020-04-14 04:26:28', '2020-04-14 04:26:28', 'firulais', 'gomez', '10.0', 8, 'noDisponible.jpg');
...
(12, '2020_04_12_024820_add_description_to_movies_table', 2),
(13, '2020_04_12_030303_add_image_portada_to_movies_table', 3),
(14, '2020_04_12_030401_add_image_background_to_movies_table', 3),
(15, '2020_04_12_030512_add_image_profile_to_actors_table', 3);
...
CREATE TABLE `movies` (
  ...
  `imagen_portada` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `movies` (`id`, `created_at`, `updated_at`, `title`, `description`, `rating`, `awards`, `release_date`, `length`, `genre_id`, `imagen_portada`, `imagen_background`) VALUES
(1, NULL, '2020-04-22 00:20:49', 'Avatar 2', 'avatar 2', '7.9', 3, '2010-10-04 00:00:00', 120, 3, 'avatar1.jpg', 'avatar1.jpg'),
(2, NULL, '2020-04-15 08:37:18', 'Titanic', 'Una joven de la alta sociedad abandona a su arrogante pretendiente por un artista humilde en el trasatlántico que se hundió durante su viaje inaugural.', '7.7', 11, '1997-09-04 00:00:00', 320, 3, 'titani2.jpg', 'titanic1.jpg'),
(3, NULL, '2020-04-15 08:52:51', 'La Guerra de las galaxias: Episodio VI', 'La nave en la que viaja la princesa Leia es capturada por las tropas imperiales al mando del temible Darth Vader. Antes de ser atrapada, Leia consigue introducir un mensaje en su robot R2-D2, quien acompañado de su inseparable C-3PO logra escapar.', '9.1', 7, '2004-07-04 00:00:00', 125, 5, 'galaxia1.jpg', 'galaxia2.jpg'),
(4, NULL, '2020-04-15 08:58:03', 'La Guerra de las galaxias: Episodio VII', 'La Guerra de las galaxias: Episodio VII', '9.0', 6, '2003-11-04 00:00:00', 180, 5, 'Episodio VII.jpg', 'Episodio VII2.jpg'),
(5, NULL, '2020-04-15 08:58:57', 'Parque Jurasico', 'Tres expertos y otras personas son invitados a un parque de diversiones, donde se encuentran dinosaurios creados en base al ADN.', '8.3', 5, '1999-01-04 00:00:00', 270, 5, 'park1.jpg', 'park2.jpg'),
(6, NULL, '2020-04-15 08:59:34', 'Harry Potter y las Reliquias de la Muerte - Parte 2', 'Harry Potter y las Reliquias de la Muerte - Parte 2', '9.0', 2, '2008-07-04 00:00:00', 190, 6, 'harry7-2.jpg', 'harry7-1.jpg'),
(7, NULL, '2020-04-15 09:01:55', 'Transformers: el lado oscuro de la luna', 'Transformers: el lado oscuro de la luna', '0.9', 1, '2005-07-04 00:00:00', 124, 5, 'transform2.png', 'transform1.jpg'),
(8, NULL, '2020-04-15 09:02:44', 'Harry Potter y la piedra filosofal', 'Harry Potter y la piedra filosofal', '10.0', 1, '2008-04-04 00:00:00', 120, 8, 'harry1-2.jpg', 'harry1-1.jpg'),
(9, NULL, '2020-04-15 09:03:28', 'Harry Potter y la cámara de los secretos', 'Harry Potter y la cámara de los secretos', '3.5', 2, '2009-08-04 00:00:00', 200, 8, 'harry2-1.jpg', 'harry2-2.jpg'),
(10, NULL, '2020-04-15 09:04:18', 'El rey león', 'El rey león', '9.1', 3, '2000-02-04 00:00:00', 111, 10, 'rey-1.jpg', 'rey-2.jpg'),
(11, NULL, NULL, 'Alicia en el país de las maravillas', '', '5.7', 2, '2008-07-04 00:00:00', 120, NULL, '', ''),
(12, NULL, '2020-04-15 09:08:32', 'Buscando a Nemo', 'Buscando a Nemo', '8.3', 2, '2000-07-04 00:00:00', 110, 7, 'nemo-1.jpg', 'nemo-2.jpg'),
(13, NULL, '2020-04-15 09:09:26', 'Toy Story', 'Toy Story', '6.1', 0, '2008-03-04 00:00:00', 150, 7, 'toy_story2.jpg', 'toy_story1.jpg'),
(14, NULL, '2020-04-15 09:10:15', 'Toy Story 2', 'Toy Story 2', '3.2', 2, '2003-04-04 00:00:00', 120, 7, 'Toy_Story_2-1.jpg', 'toy_story2-1.jpg'),
(15, NULL, '2020-04-15 09:11:59', 'La vida es bella', 'La vida es bella', '8.3', 5, '1994-10-04 00:00:00', 121, 3, 'La vida es bella1.jpg', 'La vida es bella2.jpg'),
(16, NULL, '2020-04-15 09:14:15', 'Mi pobre angelito', 'Mi pobre angelito', '3.2', 1, '1989-01-04 00:00:00', 120, 1, 'Mi pobre angelito2.jpg', 'Mi pobre angelito1.jpg'),
(17, NULL, NULL, 'Intensamente', '', '9.0', 2, '2008-07-04 00:00:00', 120, 7, '', ''),
(18, NULL, '2020-04-21 10:53:24', 'Carrozas de fuego', 'Carrozas de fuego', '9.9', 7, '1980-07-04 00:00:00', 180, 3, 'Carrozas de fuego1.jpg', 'Carrozas de fuego2.jpg'),
(19, NULL, '2020-04-21 10:57:10', 'Big', 'big', '7.3', 2, '1988-02-04 00:00:00', 130, 8, 'big1.jpg', 'big2.jpg'),
(20, NULL, NULL, 'I am Sam', '', '9.0', 4, '1999-03-04 00:00:00', 130, 3, '', ''),
(21, NULL, '2020-04-15 08:16:08', 'Hotel Transylvania', 'hotel', '7.0', 1, '2012-05-04 00:00:00', 90, 10, '', ''),
(38, '2020-04-21 02:00:43', '2020-04-21 21:33:30', 'king kong 3', 'gorila', '9.9', 12, '2003-01-12 00:00:00', 213, 7, 'pochoclo.jpg', 'pochoclo.jpg'),
(39, '2020-04-21 02:10:23', '2020-04-21 04:19:25', 'red', 'red', '3.4', 124, '2008-08-11 00:00:00', 123, 2, 'pochoclo.jpg', 'pochoclo.jpg'),
(41, '2020-04-21 21:35:51', '2020-04-21 21:35:51', 'Blue', 'blue', '9.8', 12, '2003-02-22 00:00:00', 132, 4, 'pochoclo.jpg', 'pochoclo.jpg'),
(42, '2020-04-22 00:26:28', '2020-04-22 00:26:28', 'deadpool', 'deadpool', '9.3', 12, '2001-11-22 00:00:00', 212, 6, 'dead1.jpg', 'pochoclo.jpg'),
(43, '2020-04-22 06:00:15', '2020-04-22 06:00:15', 'el irlandes', 'el perro', '4.5', 12, '2003-02-22 02:02:00', 212, 1, 'irla1.jpg', 'pochoclo.jpg');
...
(1, 'juan', 'juan@gmail.com', '$2y$10$5Q5u1sot8WjvMEeRPr36zOwXK3nY6pqD0gY04qwWkLj1mbR.dT.ty', NULL, '2020-04-11 04:05:52', '2020-04-11 04:05:52'),
(2, 'administrador', 'admin@peliculas.com', '$2y$10$RuixNhVx.Y0xvdb.rETNguQ107vCy0TpmlYa6mXeYMZvShpxsKFwe', NULL, '2020-04-14 09:23:17', '2020-04-14 09:23:17'),
(3, 'Agustin', 'agustin@google.com', '$2y$10$qJhMJiI1YnC4E3zvLRVxNOc2Ly6YA6Svq7lc9q9VkuTpLBB8nHCIy', NULL, '2020-04-14 09:24:47', '2020-04-14 09:24:47'),
(4, 'lean', 'lean@gmail.com', '$2y$10$ORAEA2FYnvLAxlZLQ1lVo..nQvLujofpRQXp4MKtBeo/Uq5Wk8PsC', NULL, '2020-04-15 03:32:39', '2020-04-15 03:32:39');
